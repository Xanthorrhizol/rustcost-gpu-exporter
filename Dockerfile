...
ARG APP_NAME=rustcost-gpu-exporter
...
# Install build dependencies (OpenSSL optional, adjust if you need CUDA headers)
RUN apt-get update && \
...
ENTRYPOINT ["/usr/local/bin/rustcost-gpu-exporter"]
CMD ["serve"]
